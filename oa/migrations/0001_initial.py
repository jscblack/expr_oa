    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PersonNo', models.IntegerField(primary_key=True, serialize=False)),
                ('PersonEmail', models.EmailField(max_length=254)),
                ('PersonActive', models.BooleanField(default=True)),
                ...
                ('PersonGender', models.IntegerField(choices=[(0, 'Female'), (1, 'Male')])),
